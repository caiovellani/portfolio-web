...
export function ExperienceCard({
  ...
  return (
    <div className="flex items-center justify-center">
      <div className="group flex flex-col gap-4 mt-9 w-full max-w-3xl border border-accent rounded-2xl p-4 bg-[#18181B] transition-transform duration-300 hover:scale-[1.01]">
